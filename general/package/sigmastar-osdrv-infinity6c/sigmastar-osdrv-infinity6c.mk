...
SIGMASTAR_OSDRV_INFINITY6C_INSTALL_STAGING = YES

define SIGMASTAR_OSDRV_INFINITY6C_INSTALL_STAGING_CMDS
	$(INSTALL) -m 755 -d $(STAGING_DIR)/usr/include/sigmastar
	$(INSTALL) -m 644 -t $(STAGING_DIR)/usr/include/sigmastar $(SIGMASTAR_OSDRV_INFINITY6C_PKGDIR)/files/include/*
	$(INSTALL) -m 755 -d $(STAGING_DIR)/usr/lib
	$(INSTALL) -m 644 -t $(STAGING_DIR)/usr/lib $(SIGMASTAR_OSDRV_INFINITY6C_PKGDIR)/files/lib/*
endef
